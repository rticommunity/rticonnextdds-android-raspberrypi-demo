/* BMP_temp_pressure_subscriber.cxx
   ...
   Example subscription of type BMP_pressure automatically generated by 
...
extern "C" int subscriber_main(int domainId, int sample_count)
{
    ...
    DDSTopic *topic = NULL;
    BMP_pressureListener *reader_listener = NULL; 
    ...
    reader_listener = new BMP_pressureListener();
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
        ...
        printf("BMP_pressure subscriber sleeping for %d sec...\n",
               receive_period.sec);
