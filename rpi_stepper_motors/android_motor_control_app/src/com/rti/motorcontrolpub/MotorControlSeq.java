...
/**
 * A sequence of MotorControl instances.
 */
@SuppressWarnings("serial")
public final class MotorControlSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public MotorControlSeq() {
        super(MotorControl.class);
    }


    public MotorControlSeq(int initialMaximum) {
        super(MotorControl.class, initialMaximum);
    }


    @SuppressWarnings("rawtypes")
	public MotorControlSeq(Collection elements) {
        super(MotorControl.class, elements);
    }
