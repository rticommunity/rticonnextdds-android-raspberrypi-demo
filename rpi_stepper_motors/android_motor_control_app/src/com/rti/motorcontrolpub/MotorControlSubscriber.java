...
public class MotorControlSubscriber {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------
    ...
    private MotorControlSubscriber() {
        super();
    }
    ...
    private static void subscriberMain(int domainId, int sampleCount) {
        ...
        MotorControlDataReader reader = null;
        ...
        try {
            ...
            listener = new MotorControlListener();
    
            /* To customize data reader QoS, use
               the configuration file USER_QOS_PROFILES.xml */
    
            reader = (MotorControlDataReader)
            ...
            for (int count = 0;
                 ...
                 ++count) {
                System.out.println("MotorControl subscriber sleeping for "
    ...
    private static class MotorControlListener extends DataReaderAdapter {
            
        MotorControlSeq _dataSeq = new MotorControlSeq();
        SampleInfoSeq _infoSeq = new SampleInfoSeq();

        public void on_data_available(DataReader reader) {
            MotorControlDataReader MotorControlReader =
                (MotorControlDataReader)reader;
            
            try {
                MotorControlReader.take(
                    _dataSeq, _infoSeq,
                ...
                for(int i = 0; i < _dataSeq.size(); ++i) {
                    ...
                    if (info.valid_data) {
                        System.out.println(
                            ((MotorControl)_dataSeq.get(i)).toString("Received",0));
                ...
                MotorControlReader.return_loan(_dataSeq, _infoSeq);
            }
        }
    }
}
