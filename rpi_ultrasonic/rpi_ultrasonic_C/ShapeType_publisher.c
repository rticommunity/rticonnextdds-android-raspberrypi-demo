...
static int publisher_main(int domainId, int sample_count)
{
    ...
    /* To customize topic QoS, use 
       the configuration file USER_QOS_PROFILES.xml */
    topic_square = DDS_DomainParticipant_create_topic(
        participant, "Square",
    ...
    /* To customize data writer QoS, use 
       the configuration file USER_QOS_PROFILES.xml */
    writer_square = DDS_Publisher_create_datawriter(
        publisher, topic_square,
   ...
   while(1) {
    ...
    int cost = readSensor(TRIGGER_PIN1, ECHO_PIN1);
        ...
        retcode = ShapeTypeDataWriter_write(
             ShapeType_writer_square, instance, &instance_handle);
        if (retcode != DDS_RETCODE_OK) {
