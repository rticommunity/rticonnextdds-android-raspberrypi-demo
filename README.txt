...
What problem does it solve:
  ...
  Systems integration via platform agnostics.
      A process of bringing together discrete systems utilizing a variety of techniques and component subsystems, and ensuring
...
To exchange various types of data (i.e., Values, Events, Alarms, Commands, Streams) coordinated between publishers and subscribers.
